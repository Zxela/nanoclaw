...
describe('GroupQueue', () => {
  ...
  it('drains interactive messages before tasks for same group', async () => {
    ...
    // Interactive messages should drain before tasks
    expect(executionOrder[0]).toBe('messages'); // first call
    expect(executionOrder[1]).toBe('messages'); // pending messages drain first
